...
import { generateMinimalConfigString, mergeInstructionEntry, parseOpenCodeConfig, serializeConfig, } from './opencode-config.js';
    ...
    try {
        ...
        const resourceDetail = (resourceKey) => {
            ...
            if (resourceKey === failedResource)
                return `write failed: ${failedError.message}`;
