...
test('T036: baseline reporting never changes Runtime Guard deny, sensitive, or ChangeBudget protection', () => {
  const common = { policyDecision: 'PASS' as const, mutationIntent: 'mutate' as const, isInited: true, isPathDenied: false, isPathNotAllowed: false, isSensitive: { dependencies: false, migrations: false, config: false, publicApi: false }, newFileDenied: false, isTargetResolved: true };
